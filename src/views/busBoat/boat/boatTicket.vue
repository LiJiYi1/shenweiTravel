<template>
    <div>
        ...
        <!-- 搜索按钮 -->
        <el-button @click="searchBoatTicket" :color="color" style="width: 200px;height:60px;margin-left:calc(50% - 100px);border-radius:20px;margin-top:20px">船票查询</el-button>
      </el-card>
