<template>
    <div>
          <div body-style="padding:0px;" style="border-radius:18px">  
    <canvas  ref="webgl"  width="1580" height="710"></canvas>
    <div style="position: absolute;left:220px;top:50px">
         <p>404 Not Found!<br>
            血染沧海千层浪,红霞映水万点光!<br>
            你的页面迷失于孤独之海~~~
        </p>
        <el-button class="button" type="warning" @click="back()">back to home</el-button>
    </div>
