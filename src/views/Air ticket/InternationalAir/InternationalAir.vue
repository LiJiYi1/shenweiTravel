<template>
    ...
    <el-radio-group v-model="oneOrTwo">
      ...
      <el-radio value="3" size="large" @change="isMore">多程</el-radio>
    </el-radio-group>
    <!-- 对城市提示 -->
    ...
    <!-- 携带婴儿 -->
    <el-checkbox v-model="checked2" label="携带婴儿(14天-2岁)" size="large" />
        </div>
    <!-- 搜索按钮 -->
    <el-button style="width: 200px;height:60px;margin-top:2px;margin-left:225px;border-radius:20px">搜索机票</el-button>
      </el-card>
        ...
        <div style="background: gray;padding:10px">热门城市/国家（支持汉字/拼音/英文字母</div>
            <el-tabs type="border-card">
               ...
               <el-tab-pane label="国际/中国港澳台" class="hot">
                     ...
                     <span @click="changeNames('普吉岛')">普吉岛</span>
...
//失去焦点让他提示消失
function blur1(){
    setTimeout(()=>{posSearch.value=false;},200)
}
function blur2(){
    setTimeout(()=>{posSearch1.value=false;},200)
}
