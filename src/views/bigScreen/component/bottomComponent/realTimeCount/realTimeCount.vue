...
<script setup>
  ...
  import chinajson from '@/assets/bigScreen/chinaMap.json'
  //拿到盛放echart的dom元素
    ...
    .realTimeCount{
        ...
        .title{
               ...
               p{
                ...
                line-height: 40px;
                padding-left: 48px;
                background: url('@/assets/bigScreen/images/map-title-bg.png') no-repeat;
                margin-top: 10px;
               } 
        }
        .container{
