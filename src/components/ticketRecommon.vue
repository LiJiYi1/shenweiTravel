<template>
    <div>
     <el-card class="bottom">
        <div>
            <h1>地图导航</h1>
            <iframe style="margin-top: 20px;"  src="https://map.baidu.com/" width="100%" height="400" frameborder="0" allowfullscreen></iframe>
            <div  style="font-size:14px;margin-top:40px">探索世界从未如此简单，欢迎来到神威旅行 —— 您全方位的旅行伙伴！</div>
