          ...
          <ul>
            <li>
             ...
             <li>
              ...
              <el-input v-model="phoneNum"  style="display:inline-block;width: 240px" placeholder="必填,方便定制师与您联络"/>
            </li>
            ...
            <span style="display:inline-block;margin-left:75px;font-size: 12px;width:420px;color: #999;text-align:left;margin-top:20px">*提交需求后会有专业定制师联系您，为您免费制作方案，可根据实际情况调整细节</span>
            <span style="display:inline-block;margin-left:75px;font-size: 12px;width:420px;color: #999;text-align:left;margin-top:25px">*神威旅行网定制旅游平台展示的定制产品均由具备相关资质的合作商家直接提供，神威旅行网仅作为网络预订平台。合作商家充分借用神威旅行网定制旅游平台，推出全方位的定制旅游产品，并负责产品销售、资源确认、合同签署、发票开具、行程安排等全部环节的旅游服务。神威旅行网作为定制旅游产品的展示平台。</span>
          </ul>
